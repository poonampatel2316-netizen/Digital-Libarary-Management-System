...
<body>
    ...
    <div class="auth">
        <!-- Login -->
        <a href="login.php" class="btn login" style="text-decoration: none;">Login</a>

        <!-- Signup Dropdown -->
        <div class="dropdown">
            <button href="signup.php" class="btn signup" onclick="toggleMenu()">Sign Up ▾</button>
            ...
            <div class="dropdown-content">
                ...
                <?php elseif (isset($role) && $role === "user"): ?>
                    <a href="user/dashboard.php">User Panel</a>
                <?php else: ?>
